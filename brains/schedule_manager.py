...
def run_schedule_manager():
    # schedule.every().day.at("00:30").do(add_task, func=my_shows.run_code)
    # schedule.every().day.at("01:00").do(add_task, func=ai_models.run_code)
    ...
    # schedule.every().day.at("05:00").do(add_task, func=my_shows.run_code)
